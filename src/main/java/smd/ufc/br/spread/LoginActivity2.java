...
public class LoginActivity2 extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private LoginActivity2.UserLoginTask mAuthTask = null;
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                Uri.withAppendedPath(ContactsContract.Profile.CONTENT_URI,
                        ContactsContract.Contacts.Data.CONTENT_DIRECTORY), LoginActivity2.ProfileQuery.PROJECTION,
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        while (!cursor.isAfterLast()) {
            emails.add(cursor.getString(LoginActivity2.ProfileQuery.ADDRESS));
            cursor.moveToNext();
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String url = getResources().getString(R.string.server_url) + "/login/auth";
            ...
            try {
                ...
                try{
                    ...
                    util.setName(name);
                    Toast.makeText(LoginActivity2.this, "Olá, " + name, Toast.LENGTH_SHORT).show();
                ...
                if(error instanceof AuthFailureError){
                    ...
                    Toast.makeText(LoginActivity2.this, "Senha incorreta", Toast.LENGTH_SHORT).show();
                } else if(error instanceof TimeoutError){
                    //erro de rede
                    Log.d(TAG, "onResponse: Não foi possível se conectar ao servidor.");
                    Toast.makeText(LoginActivity2.this, "Não foi possível se conectar ao servidor.", Toast.LENGTH_SHORT).show();
                }
